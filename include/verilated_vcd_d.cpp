...
VerilatedVcdFile* createVcdFile() { return new VerilatedVcdFile(); }

ESDLVerilatedVcdD::ESDLVerilatedVcdD(VerilatedVcdFile* filep) {
    m_vcd_c = new VerilatedVcdC(filep);
}
...
void ESDLVerilatedVcdD::rolloverSize(size_t rolloverSize) VL_MT_SAFE {
    m_vcd_c->rolloverSize(rolloverSize);
}
...
// Users should not need to call this, as for Verilated models, these
// propage from the Verilated default timeunit
void ESDLVerilatedVcdD::set_time_unit(const char* unit) VL_MT_SAFE {
    m_vcd_c->set_time_unit(unit);
}

void ESDLVerilatedVcdD::set_time_unit(const std::string& unit) VL_MT_SAFE {
    m_vcd_c->set_time_unit(unit);
}
...
// Users should not need to call this, as for Verilated models, these
// propage from the Verilated default timeprecision
void ESDLVerilatedVcdD::set_time_resolution(const char* unit) VL_MT_SAFE {
...
VerilatedVcdC* ESDLVerilatedVcdD::getVcdC() { return m_vcd_c; }

VerilatedTraceBaseC* ESDLVerilatedVcdD::getTraceBase() { return m_vcd_c; }
